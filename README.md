...
PEGASUS-powered abstractive text summarization system with React + Flask deployment.

## Highlights
- Fine-tuned PEGASUS summarization model
- Two-stage training using CNN/DailyMail + technical text
